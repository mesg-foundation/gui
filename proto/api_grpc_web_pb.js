 ...
 * @const
 * @type {!grpc.web.AbstractClientBase.MethodInfo<
 *   !proto.api.CreateWorkflowRequest,
 *   !proto.api.CreateWorkflowReply>}
 */
const methodInfo_Core_CreateWorkflow = new grpc.web.AbstractClientBase.MethodInfo(
  proto.api.CreateWorkflowReply,
  /** @param {!proto.api.CreateWorkflowRequest} request */
  function(request) {
    return request.serializeBinary();
  },
  proto.api.CreateWorkflowReply.deserializeBinary
);


/**
 * @param {!proto.api.CreateWorkflowRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.api.CreateWorkflowReply)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.api.CreateWorkflowReply>|undefined}
 *     The XHR Node Readable Stream
 */
proto.api.CoreClient.prototype.createWorkflow =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/api.Core/CreateWorkflow',
      request,
      metadata || {},
      methodInfo_Core_CreateWorkflow,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.api.CreateWorkflowReply>}
 *     The XHR Node Readable Stream
 */
proto.api.CorePromiseClient.prototype.createWorkflow =
    function(request, metadata) {
  return new Promise((resolve, reject) => {
    this.delegateClient_.createWorkflow(
      request, metadata, (error, response) => {
        error ? reject(error) : resolve(response);
      });
  });
 ...
 * @const
 * @type {!grpc.web.AbstractClientBase.MethodInfo<
 *   !proto.api.DeleteWorkflowRequest,
 *   !proto.api.DeleteWorkflowReply>}
 */
const methodInfo_Core_DeleteWorkflow = new grpc.web.AbstractClientBase.MethodInfo(
  proto.api.DeleteWorkflowReply,
  /** @param {!proto.api.DeleteWorkflowRequest} request */
  function(request) {
    return request.serializeBinary();
  },
  proto.api.DeleteWorkflowReply.deserializeBinary
);


/**
 * @param {!proto.api.DeleteWorkflowRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.api.DeleteWorkflowReply)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.api.DeleteWorkflowReply>|undefined}
 *     The XHR Node Readable Stream
 */
proto.api.CoreClient.prototype.deleteWorkflow =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/api.Core/DeleteWorkflow',
      request,
      metadata || {},
      methodInfo_Core_DeleteWorkflow,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.api.DeleteWorkflowReply>}
 *     The XHR Node Readable Stream
 */
proto.api.CorePromiseClient.prototype.deleteWorkflow =
    function(request, metadata) {
  return new Promise((resolve, reject) => {
    this.delegateClient_.deleteWorkflow(
      request, metadata, (error, response) => {
        error ? reject(error) : resolve(response);
      });
  });
